#!/usr/bin/python
# Author: Steve Toback
# Based on Sample AWS code, http://kookye.com/2017/06/01/design-a-voltmeter-with-the-raspberry-pi-board-and-voltage-sensor/
...
print"***********"
print' '
JSONPayload = '{"state":{"reported": {"voltage":' + str("%.2f"%voltage) +  '}}}'
print(JSONPayload)
